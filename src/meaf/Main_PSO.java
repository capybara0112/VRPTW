...
/**
 * Main entry point chỉ để chạy PSO độc lập.
 * Xuất file CSV và vẽ biểu đồ như bình thường (các cột GA, ACS, MEAF sẽ là 0).
 */
public class Main_PSO {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("╔══════════════════════════════════════════════════════════╗");
        System.out.println("║  MEAVRPTW – PSO Standalone Run                          ║");
        System.out.println("╚══════════════════════════════════════════════════════════╝");
        ...
        AlgoResult gaResult   = new AlgoResult("GA",   0, 0, 0, 0, zeroHistory);
    ...
    // ========== Các hàm runner (chỉ dùng runPSO) ==========
    @FunctionalInterface
